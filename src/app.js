(function () {
  const cityCatalog = {
    ...
    newyork: { countryKey: "usa", country: "США", city: "Нью-Йорк", center: [40.758, -73.9855], zoom: 12 },
    rome: { countryKey: "italy", country: "Италия", city: "Рим", center: [41.9028, 12.4964], zoom: 12 },
    warsaw: { countryKey: "poland", country: "Польша", city: "Варшава", center: [52.2297, 21.0122], zoom: 12 }
  };

  const countryCatalog = {
    russia: { label: "Россия", center: [61, 96], zoom: 4 },
    usa: { label: "США", center: [39.8, -98.5], zoom: 4 },
    italy: { label: "Италия", center: [42.6, 12.6], zoom: 6 },
    poland: { label: "Польша", center: [52.1, 19.2], zoom: 6 }
  };

  const extraDataByCity = {
    newyork: [
      {
        id: "ny-earthcam-times-square",
        ...
        embedUrl: "",
        tags: ["earthcam", "city view", "usa"],
        description: "Панорамная камера на Таймс-сквер.",
        accessNote: "Некоторые международные источники могут ограничивать iframe-встраивание."
      }
    ],
    rome: [
      {
        id: "rome-skyline-colosseum",
        name: "Колизей (SkylineWebcams)",
        ...
        embedUrl: "",
        tags: ["skylinewebcams", "landmark", "italy"],
        description: "Камера с видом на Колизей в Риме.",
        accessNote: "Некоторые международные источники могут ограничивать iframe-встраивание."
      }
    ],
    warsaw: [
      {
        id: "warsaw-worldcam-center",
        name: "Центр Варшавы (WorldCam)",
        district: "Śródmieście",
        location: "Warsaw City Center",
        lat: 52.2297,
        lng: 21.0122,
        sourceName: "WorldCam",
        sourceUrl: "https://worldcam.eu/webcams/poland/warsaw/",
        embedUrl: "",
        tags: ["worldcam", "city view", "poland"],
        description: "Городской вид на центр Варшавы.",
        accessNote: "Некоторые международные источники могут ограничивать iframe-встраивание."
      }
    ]
  };
